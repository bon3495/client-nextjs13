...
const buttonVariants = cva(
  'inline-flex items-center justify-center rounded-sm text-base font-medium focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:opacity-25 disabled:pointer-events-none active:scale-95 transition-all duration-200 focus:ring-offset-2 outline-none',
  {
    variants: {
      variant: {
        default:

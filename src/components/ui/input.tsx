  ...
  ({ error, className, type = 'text', disabled, ...props }, ref) => {
    return (
      <input
        ...
        disabled={disabled}
        className={cn(
          'flex h-12 w-full rounded-sm border bg-transparent px-3 py-2 text-base ring-offset-background file:border-0 file:bg-transparent file:text-base file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-4 disabled:cursor-not-allowed disabled:opacity-50 transition-all duration-200 outline-none',
          {
